...
const UI = (function() {
     ...
     * Update HP display
     */
    function updateHP(hp, maxHp = 100) {
        if (elements.hpValue) {
     ...
     */
    function updateCalibrationPitch(note) {
     ...
     */
    function updateCalibrationStability(percent) {
     ...
     */
    function startMetronome(onBeat) {
        stopMetronome();
        currentBeat = 0;
     ...
     */
    function updatePlayedNotes(played, expected) {
     ...
     */
    function updateGameplayInstruction(text) {
    ...
    return {
        ...
        // Access elements for event binding
